...
# Room and Inventory Models - Added by Vibe
class Room(Base):
    __tablename__ = "rooms"
    id = Column(String(36), primary_key=True, default=lambda: str(uuid.uuid4()))
    ...
    has_heater = Column(Boolean, default=False)
    furniture = Column(JSON)
    electronics = Column(JSON)
    cleaning_schedule = Column(String(50))
    last_cleaned = Column(Date)
    next_cleaning = Column(Date)
